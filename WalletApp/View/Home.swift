...
struct Home: View {
    ...
    var body: some View {
        VStack(spacing: 15){
            ...
            CardView(cardColor: Color("Orange"), spent: "7822.44", cardNumber: "7523", cardIndex: 1)
        }
        .padding(15)
    ...
    func DetailCardView()->some View{
        ...
        .overlay(alignment: .topTrailing){
            ...
            .offset(x: startAnimation ? 0 : -100)
            .opacity(startAnimation ? 1 : 0)
            .animation(.easeInOut(duration: 0.6).speed(0.8).delay(1.7), value: startAnimation)
        }
        .padding(15)
    ...
    @ViewBuilder
    func CardView(cardColor: Color = .white,spent: String = "5421.80", cardNumber: String = "2641", cardIndex: CGFloat = 0)->some View{
